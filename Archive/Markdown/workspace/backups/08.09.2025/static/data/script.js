...
function updateLayoutForKeyboard() {
  if (window.visualViewport) {
    const viewportHeight = window.visualViewport.height - 60; // Odjęcie marginesu
...
window.addEventListener("load", updateLayoutForKeyboard);
...
async function submitRating() {
  ...
  if (isMobile) {
    document.querySelector("textarea#prompt").setAttribute("placeholder", "Wpisz wiadomość...");
  }
